"""
Production settings for GoatMorpho on Oracle Cloud Infrastructure
Distributed architecture: Django instance + CV processing instance
"""
...
ALLOWED_HOSTS = [
    'goatmorpho.info',
    'www.goatmorpho.info',
    '130.61.39.212',  # django-instance public IP
    '10.0.0.163',     # django-instance private IP
    '10.0.1.25',      # cv-instance private IP
    'localhost',
    '127.0.0.1',
]
...
# Database configuration for PostgreSQL (Oracle Cloud compatible)
DATABASES = {
    'default': {
...
CV_PROCESSING_URL = os.environ.get('CV_PROCESSING_URL', 'http://10.0.1.25:8001')
CV_PROCESSING_TIMEOUT = 120  # 2 minutes for image processing
