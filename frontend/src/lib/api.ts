...
import type { User, Measurement, LoginCredentials, RegisterData, AuthResponse, MeasurementStats } from '../shared/types';
...
class ApiClient {
  ...
  async getMeasurements(): Promise<Measurement[]> {
    const response = await this.request<{ results: Measurement[] }>('/api/measurements/');
